...
class GetProfileInfoUseCase extends BaseUseCase<Auth, String?> {
  final AuthBaseRepository authBaseRepository;

  GetProfileInfoUseCase({required this.authBaseRepository});

  @override
  Future<Either<dynamic, Auth>> call(String? parameters) async {
    return await authBaseRepository.profileInfo(token: parameters);
  }
}
